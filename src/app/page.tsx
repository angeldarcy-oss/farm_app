...
const CATEGORIES = [
  // 🥬 考えられるあらゆる野菜・果樹・ハーブのカテゴリ（完全版）
const CATEGORIES = [
  // トマト（細分化）
  "ミニトマト", "中玉トマト", "大玉トマト",
  
  // ナス科・ウリ科（夏野菜）
  "なす", "きゅうり", "ピーマン", "パプリカ", "ししとう", "オクラ",
  "ゴーヤ", "ヘチマ", "ハヤトウリ", "冬瓜", "かぼちゃ", "ズッキーニ",
  "スイカ", "メロン",
  
  // アブラナ科・葉物野菜
  "キャベツ", "レタス", "サニーレタス", "白菜", "小松菜", "ほうれん草", 
  "青梗菜", "春菊", "水菜", "パセリ", "ブロッコリー", "カリフラワー",
  
  // 根菜類
  "じゃがいも", "さつまいも", "里芋", "長芋", "にんじん", "大根", 
  "かぶ", "ごぼう", "レンコン", "たまねぎ", "長ねぎ", "玉ねぎ",
  
  // 豆類・穀物
  "とうもろこし", "枝豆", "そら豆", "さやえんどう", "スナップエンドウ", 
  "インゲン豆", "落花生", "大豆", "小豆",
  
  // 香味・ハーブ・その他
  "にんにく", "生姜", "しそ（大葉）", "バジル", "ミント", "パクチー",
  "いちご", "ブルーベリー", "その他の果樹",
